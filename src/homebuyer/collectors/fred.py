"""Collector for mortgage rate data from FRED (Federal Reserve Economic Data).

Uses the direct CSV download endpoint which requires no API key.
Fetches MORTGAGE30US (30-year fixed) and MORTGAGE15US (15-year fixed) series.
"""
...
from homebuyer.config import FRED_CSV_URL, FRED_SERIES_15YR, FRED_SERIES_30YR
from homebuyer.storage.database import Database
from homebuyer.storage.models import CollectionResult, MortgageRate
