 ...
 * button. The full detailed document is generated client-side as a letter-size
...
function DownloadButton({ data }: { data: InvestmentProspectusResponse }) {
  ...
  return (
    ...
    >
      ...
      {loading ? 'Generating...' : 'Download Prospectus (PDF)'}
    </button>
  );
}
