...
import { authGoogleAuthorize } from '../../lib/api';

/**
 * "or" divider + "Continue with Google" button.
 *
 * Shared between the Login page and the Marketing AuthModal.
 * Visually neutral (white bg, gray border) so it works with any page theme.
 */
